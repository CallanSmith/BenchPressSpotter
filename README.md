...
(We started off with a design that had a hook on either side. This caused the motors to twist when put under a lot of load. We ended with this design of a flat end with holes to use a clamp on the end. Here is the original hook design.
<img src="OGhook.JPG" alt="The original motor hook" width="300">
